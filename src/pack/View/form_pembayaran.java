...
public class form_pembayaran extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel4.add(jLabel7);
        jLabel7.setBounds(10, 280, 140, 40);

        jLabel8.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel8.setText("Jumlah Tanggal Resep");
        jPanel4.add(jLabel8);
        jLabel8.setBounds(10, 230, 140, 40);
        ...
        akhir.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Kode Transaksi", "NamaPetugas", "Kode Obat", "Jenis Transaksi", "Tanggal Beli", "Tanggal Resep", "HargaPerObat", "TotalPembayaran"
            }
        ) {
    ...
    private void saveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveActionPerformed
        ...
        if(noresi.getText().equals("")||petugas.getText().equals("")||nopol.getText().equals("")||
                Jenis.equals("")||tglmasuk.equals("")||tglkeluar.equals(""))
        {JOptionPane.showMessageDialog(this,"Harap Lengkapi Data","Error",JOptionPane.WARNING_MESSAGE);}
        else{
            String SQL = "INSERT INTO tb_penitipan (nomor_resi,nama_petugas,"
                    + "nomor_polisi,jenis_kendaraan,tanggal_masuk,tanggal_keluar,hari,total_pembayaran)"
                    +"VALUES('"
                    +noresi.getText()+"','"
                    +petugas.getText()+"','"
                    +nopol.getText()+"','"
    ...
    private void printActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_printActionPerformed
        MessageFormat header = new MessageFormat("Stuk Transaksi Apotek");
    ...
    private void refreshData() {
        String kolom[] = {"Kode Transaksi","Nama Petugas","Kode Obat","Jenis Transaksi","Tanggal Beli","Tanggal Resep","Harga Obat","Total Pembayaran"};
